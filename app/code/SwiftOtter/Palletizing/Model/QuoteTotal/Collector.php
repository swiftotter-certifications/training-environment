...
namespace SwiftOtter\Palletizing\Model\QuoteTotal;
...
class Collector extends AbstractTotal
{
    ...
    public function collect(
        ...
        $pallets = count($quote->getExtensionAttributes()->getPalletDetails() ?? []);
