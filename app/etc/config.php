...
return [
    'crypt' => [
        'key' => '00cb1ae00880b62b4032e648e20ba776',
    ],
    'modules' => [
        'Magento_Store' => 1,
        'Magento_Config' => 1,
        ...
        'Project_Bug2CartDetailsThatDisappear' => 1,
        'Project_Bug4SlideshowBroken' => 1,
        'Project_Bug5CheckoutLightsOut' => 1,
        'Project_Bug6CheckoutDoesntRespond' => 1,
        'Project_Common' => 1,
        'SwiftOtter_Catalog' => 1,
        'SwiftOtter_CategoryAsProduct' => 1,
        'SwiftOtter_Checkout' => 1,
        'SwiftOtter_CliPerformance' => 1,
        'SwiftOtter_Customer' => 1,
        'SwiftOtter_DownloadProduct' => 1,
        'SwiftOtter_EventQueue' => 1,
        'SwiftOtter_GiftCard' => 1,
    ...
    'themes' => [
        ...
        'frontend/SwiftOtter/OtterSplash' => [
            'parent_id' => 'Magento/luma',
            'theme_path' => 'SwiftOtter/OtterSplash',
            'theme_title' => 'SwiftOtter Otter Splash',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
     ...
     * CONFIG__DEFAULT__SALES__BRAINTREE_API__TOKENIZATION_KEY for sales/braintree_api/tokenization_key
